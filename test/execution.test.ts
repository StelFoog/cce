...
describe('Comiles and executes files', () => {
	...
	test('test/cfiles/args.c with arguments', (done) => {
	...
	test('test/cfiles/args.c without arguments', (done) => {
