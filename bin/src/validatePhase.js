...
function validatePhase(params, callback) {
    var _this = this;
    var file = params.file, onlyExecPrints = params.onlyExecPrints, executeArguments = params.executeArguments, compilerArguments = params.compilerArguments, compiler = params.compiler;
...
exports.default = validatePhase;
//# sourceMappingURL=validatePhase.js.map